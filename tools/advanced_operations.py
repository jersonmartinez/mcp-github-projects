...
(`tools.advanced_operations`) keep resolving. New code MUST import from `tools.issues.advanced_operations`.
See docs/architecture/PROJECT_STRUCTURE.md §1 (compatibility layer).
"""
import tools.issues.advanced_operations as _canon  # noqa: E402

# Re-export every module-level name (including non-__all__ symbols such as
# imported client classes that tests patch) so `patch('tools.advanced_operations.X')` resolves
